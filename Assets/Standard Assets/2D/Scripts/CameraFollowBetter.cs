...
{
    public class CameraFollowBetter : MonoBehaviour
    {
        ...
        private void TrackPlayer()
        {
            ...
            float targetX = m_Player.position.x + targetOffset.x;
            float targetY = lockY ? targetOffset.y : m_Player.position.y + targetOffset.y;
